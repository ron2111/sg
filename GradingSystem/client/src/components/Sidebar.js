          ...
          <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
            <div className="sidebar-inner px-4 pt-3">
              ...
              <Nav className="flex-column pt-3 pt-md-0">
                ...
                <NavItem external title="DTU Website" link="https://www.dtu.ac.in/" target="_blank"  image={dtu_logo} />
                <NavItem title="Attendance Marking" link={Routes.About.path} icon={faHeart} />
                <NavItem title="Time Table" link={Routes.About.path} icon={faChartPie}/>
